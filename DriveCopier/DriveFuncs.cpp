...
// List Next Directory : iterate through directory listing all folder and file names
        ...
        if (FindFileData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) {
            if (FindFileData.dwFileAttributes & FILE_ATTRIBUTE_SYSTEM) {
                ...
                if (thisDir.compare(".") == 0 || thisDir.compare("..") == 0) {
                    ...
                    DF_ListNextDirectory(rootDir); // Recursive
                }
            }
        }
        else
        ...
        if (FindFileData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) {
            if (FindFileData.dwFileAttributes & FILE_ATTRIBUTE_SYSTEM) {
                ...
                if (thisDir.compare(".") == 0 || thisDir.compare("..") == 0) {
                    ...
                    DF_CopyNextDirectory(rootDir, toDriveLetter); // Continue Recursion
                }
            }
        }
        else {
